 ...
 */
//Faculty.connectFacultyWithSub();  //代码中key是否修改为facultyKey?
//Format batch
 ...
 */
//_.values(HOSIDS).forEach(function(hospital){
//RegionController.find(hospital).then(function(region){
//  var body = region.body;
//  var districId = body._id;
//  var districtName = body.name;
//  var hospitalId = region.hos.id;
//
//  Department.find({hosId:hospitalId}).then(function(deps){
//
